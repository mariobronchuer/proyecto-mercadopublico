    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white rounded-2xl shadow-md">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900">No tienes favoritos</h3>
          <p className="mt-2 text-gray-500">
            Marca licitaciones como favoritas para verlas aquí
          </p>
          <Link
            href="/licitaciones"
            className="mt-6 inline-block bg-blue-900 text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-800 transition-colors"
          >
